...
export async function GET() {
  ...
  const lines = [
    ...
    "## HTTP API",
    "",
    `- Base: ${SITE_URL}/api/v1/stores/{storeId} — products, categories, brands, coupons, banners (GET/POST/PUT/PATCH/DELETE), import (CSV or Shopify export, dry run by default), images, seed, readiness, publish`,
