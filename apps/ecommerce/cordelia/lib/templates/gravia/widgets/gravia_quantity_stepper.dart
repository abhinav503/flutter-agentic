...
/// control in the storefront (cart rows, product detail's docked bar, the
/// quick-add sheet) renders this, never a re-typed [QuantityStepper] recipe.
class GraviaQuantityStepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return QuantityStepper(
      value: value,
      height: height,
      iconColor: GraviaColorConst.gray700,
      valueTextStyle: GraviaTextStyleConst.textMdBold(tt),
      decrementIconBuilder: (color, size) => AppSvgImage.asset(
        GraviaImageConst.minus,
        color: color,
        width: size,
        height: size,
      ),
