...
/// fill + primary text as the [GraviaProductCard] weight badge) — as
/// opposed to core's default filter-chip look (filled container + check
/// mark), which `AppChip` still renders when none of these overrides are
/// passed.
///
/// ```dart
...
class SelectorChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppChip(
      ...
      borderColor: GraviaColorConst.gray200,
