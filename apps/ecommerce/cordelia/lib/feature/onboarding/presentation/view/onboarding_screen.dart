...
class _OnboardingScreenState extends BaseScreenState<OnboardingScreen> {
  static final _items = [
    _OnboardingItem(
      image: AppNetworkImage.placeholder(seed: 'cordelia-onboarding-1'),
      title: ValueConst.onboardingTitle1,
      subtitle: ValueConst.onboardingSubtitle1,
    ),
    _OnboardingItem(
      image: AppNetworkImage.placeholder(seed: 'cordelia-onboarding-2'),
      title: ValueConst.onboardingTitle2,
      subtitle: ValueConst.onboardingSubtitle2,
    ),
    _OnboardingItem(
      image: AppNetworkImage.placeholder(seed: 'cordelia-onboarding-3'),
