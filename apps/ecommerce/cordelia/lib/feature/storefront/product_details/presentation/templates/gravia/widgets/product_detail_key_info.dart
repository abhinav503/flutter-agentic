...
class _ProductDetailKeyInfoState extends State<ProductDetailKeyInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    final bodyStyle = GraviaTextStyleConst.textMdRegular(
      tt,
    ).copyWith(color: cs.onSurface);
    final toggleStyle = GraviaTextStyleConst.textMdRegular(
      tt,
          ...
          Text.rich(
            TextSpan(
              children: [
                ...
                TextSpan(
                  text: ' ${GraviaValueConst.readLess}',
                  style: toggleStyle,
  ...
  TextSpan _truncatedSpan({
    ...
    final toggleSpan = TextSpan(
      text: '… ${GraviaValueConst.readMore}',
      style: toggleStyle,
      recognizer: toggleRecognizer,
    );
