...
mixin _$ProductDetailsEvent {
 ...
 String get storeId; String get productId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductDetailsEvent&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.productId, productId) || other.productId == productId));
}
...
@override
String toString() {
  return 'ProductDetailsEvent(storeId: $storeId, productId: $productId)';
}
...
/// Create a copy of ProductDetailsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? storeId = null,Object? productId = null,}) {
...
class ProductDetailsStarted implements ProductDetailsEvent {
  const ProductDetailsStarted({required this.storeId, required this.productId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductDetailsStarted&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.productId, productId) || other.productId == productId));
}
...
@override
String toString() {
  return 'ProductDetailsEvent.started(storeId: $storeId, productId: $productId)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( ProductDetailEntity detail)?  loaded,TResult Function( String message,  String storeId,  String productId)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ProductDetailsLoading() when loading != null:
...
return error(_that.message,_that.storeId,_that.productId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( ProductDetailEntity detail)  loaded,required TResult Function( String message,  String storeId,  String productId)  error,}) {final _that = this;
switch (_that) {
case ProductDetailsLoading():
return loading();case ProductDetailsLoaded():
return loaded(_that.detail);case ProductDetailsError():
return error(_that.message,_that.storeId,_that.productId);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( ProductDetailEntity detail)?  loaded,TResult? Function( String message,  String storeId,  String productId)?  error,}) {final _that = this;
switch (_that) {
case ProductDetailsLoading() when loading != null:
return loading();case ProductDetailsLoaded() when loaded != null:
return loaded(_that.detail);case ProductDetailsError() when error != null:
...
class ProductDetailsError implements ProductDetailsState {
  const ProductDetailsError({required this.message, required this.storeId, required this.productId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductDetailsError&&(identical(other.message, message) || other.message == message)&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.productId, productId) || other.productId == productId));
}


@override
int get hashCode => Object.hash(runtimeType,message,storeId,productId);

@override
String toString() {
  return 'ProductDetailsState.error(message: $message, storeId: $storeId, productId: $productId)';
}
...
@useResult
$Res call({
 String message, String storeId, String productId
});
...
/// Create a copy of ProductDetailsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,Object? storeId = null,Object? productId = null,}) {
