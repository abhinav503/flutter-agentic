...
class AddRecentSearchParams {
  ...
  const AddRecentSearchParams({required this.storeId, required this.item});
}
...
class AddRecentSearchUseCase
  ...
  Future<Either<Failure, List<RecentSearchEntity>>> call(
    AddRecentSearchParams params,
  ) => _repository.addRecentSearch(params.storeId, params.item);
}
