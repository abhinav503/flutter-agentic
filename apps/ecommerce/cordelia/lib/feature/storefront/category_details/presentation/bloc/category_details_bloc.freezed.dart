...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String storeId,  String categoryId,  String categoryName)?  started,TResult Function( ProductSortOption sort)?  sortChanged,TResult Function( ProductPriceFilter priceFilter)?  priceFilterChanged,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CategoryDetailsStarted() when started != null:
return started(_that.storeId,_that.categoryId,_that.categoryName);case CategoryDetailsSortChanged() when sortChanged != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String storeId,  String categoryId,  String categoryName)  started,required TResult Function( ProductSortOption sort)  sortChanged,required TResult Function( ProductPriceFilter priceFilter)  priceFilterChanged,}) {final _that = this;
switch (_that) {
case CategoryDetailsStarted():
return started(_that.storeId,_that.categoryId,_that.categoryName);case CategoryDetailsSortChanged():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String storeId,  String categoryId,  String categoryName)?  started,TResult? Function( ProductSortOption sort)?  sortChanged,TResult? Function( ProductPriceFilter priceFilter)?  priceFilterChanged,}) {final _that = this;
switch (_that) {
case CategoryDetailsStarted() when started != null:
return started(_that.storeId,_that.categoryId,_that.categoryName);case CategoryDetailsSortChanged() when sortChanged != null:
return sortChanged(_that.sort);case CategoryDetailsPriceFilterChanged() when priceFilterChanged != null:
...
class CategoryDetailsStarted implements CategoryDetailsEvent {
  const CategoryDetailsStarted({required this.storeId, required this.categoryId, required this.categoryName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryDetailsStarted&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.categoryName, categoryName) || other.categoryName == categoryName));
}


@override
int get hashCode => Object.hash(runtimeType,storeId,categoryId,categoryName);

@override
String toString() {
  return 'CategoryDetailsEvent.started(storeId: $storeId, categoryId: $categoryId, categoryName: $categoryName)';
}
...
@useResult
$Res call({
 String storeId, String categoryId, String categoryName
});
...
/// Create a copy of CategoryDetailsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? storeId = null,Object? categoryId = null,Object? categoryName = null,}) {
...
return error(_that.message,_that.storeId,_that.categoryId,_that.categoryName);case _:
  return orElse();
...
return error(_that.message,_that.storeId,_that.categoryId,_that.categoryName);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class CategoryDetailsError implements CategoryDetailsState {
  const CategoryDetailsError({required this.message, required this.storeId, required this.categoryId, required this.categoryName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryDetailsError&&(identical(other.message, message) || other.message == message)&&(identical(other.storeId, storeId) || other.storeId == storeId)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.categoryName, categoryName) || other.categoryName == categoryName));
}


@override
int get hashCode => Object.hash(runtimeType,message,storeId,categoryId,categoryName);

@override
String toString() {
  return 'CategoryDetailsState.error(message: $message, storeId: $storeId, categoryId: $categoryId, categoryName: $categoryName)';
}
...
@useResult
$Res call({
 String message, String storeId, String categoryId, String categoryName
});
...
/// Create a copy of CategoryDetailsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,Object? storeId = null,Object? categoryId = null,Object? categoryName = null,}) {
