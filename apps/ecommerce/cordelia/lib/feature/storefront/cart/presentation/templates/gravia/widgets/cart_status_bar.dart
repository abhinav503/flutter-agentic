              ...
              child: GestureDetector(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      GraviaValueConst.exploreLabel,
                      style: GraviaTextStyleConst.textXsRegular(tt).copyWith(
                        color: cs.primary,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      GraviaValueConst.cartSummaryLabel(itemCount, grandTotal),
                      style: GraviaTextStyleConst.textXsRegular(
                        tt,
                      ).copyWith(color: onOverlay),
                    ),
                    Text(
                      GraviaValueConst.checkoutLabel,
                      style: GraviaTextStyleConst.textXsBold(
                        tt,
                      ).copyWith(color: onOverlay),
                    ),
                  ],
...
class _ClearCartButton extends StatelessWidget {
  ...
  static const _size = GraviaDimenConst.controlHeight;
