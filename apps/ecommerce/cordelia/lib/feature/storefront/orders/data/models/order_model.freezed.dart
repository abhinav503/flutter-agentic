...
// feature) omit both.
@JsonKey(name: 'coupon_code') String get couponCode;@JsonKey(name: 'coupon_discount') double get couponDiscount;// Defaulted for the same reason as the coupon pair: orders placed before
// stores could charge for delivery carry no field, and 0 is the true
// figure for them — they were all delivered free.
@JsonKey(name: 'delivery_fee') double get deliveryFee;// The shopper's rating of this delivery. Defaulted: 0 is every order
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,refundStatus,placedAt,const DeepCollectionEquality().hash(statusHistory),deliveryOtp,paymentId,couponCode,couponDiscount,deliveryFee,rating,reviewText,reviewedAt,const DeepCollectionEquality().hash(items),deliveryAddress);

@override
String toString() {
  return 'OrderModel(id: $id, status: $status, refundStatus: $refundStatus, placedAt: $placedAt, statusHistory: $statusHistory, deliveryOtp: $deliveryOtp, paymentId: $paymentId, couponCode: $couponCode, couponDiscount: $couponDiscount, deliveryFee: $deliveryFee, rating: $rating, reviewText: $reviewText, reviewedAt: $reviewedAt, items: $items, deliveryAddress: $deliveryAddress)';
}
...
@useResult
$Res call({
 String id, String status,@JsonKey(name: 'refund_status') String refundStatus,@JsonKey(name: 'placed_at') String placedAt,@JsonKey(name: 'status_history') List<OrderStatusChangeModel> statusHistory,@JsonKey(name: 'delivery_otp') String deliveryOtp,@JsonKey(name: 'payment_id') String paymentId,@JsonKey(name: 'coupon_code') String couponCode,@JsonKey(name: 'coupon_discount') double couponDiscount,@JsonKey(name: 'delivery_fee') double deliveryFee, int rating,@JsonKey(name: 'review_text') String reviewText,@JsonKey(name: 'reviewed_at') String reviewedAt, List<OrderLineItemModel> items,@JsonKey(name: 'delivery_address') AddressModel? deliveryAddress
});
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? refundStatus = null,Object? placedAt = null,Object? statusHistory = null,Object? deliveryOtp = null,Object? paymentId = null,Object? couponCode = null,Object? couponDiscount = null,Object? deliveryFee = null,Object? rating = null,Object? reviewText = null,Object? reviewedAt = null,Object? items = null,Object? deliveryAddress = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String status, @JsonKey(name: 'refund_status')  String refundStatus, @JsonKey(name: 'placed_at')  String placedAt, @JsonKey(name: 'status_history')  List<OrderStatusChangeModel> statusHistory, @JsonKey(name: 'delivery_otp')  String deliveryOtp, @JsonKey(name: 'payment_id')  String paymentId, @JsonKey(name: 'coupon_code')  String couponCode, @JsonKey(name: 'coupon_discount')  double couponDiscount, @JsonKey(name: 'delivery_fee')  double deliveryFee,  int rating, @JsonKey(name: 'review_text')  String reviewText, @JsonKey(name: 'reviewed_at')  String reviewedAt,  List<OrderLineItemModel> items, @JsonKey(name: 'delivery_address')  AddressModel? deliveryAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.status,_that.refundStatus,_that.placedAt,_that.statusHistory,_that.deliveryOtp,_that.paymentId,_that.couponCode,_that.couponDiscount,_that.deliveryFee,_that.rating,_that.reviewText,_that.reviewedAt,_that.items,_that.deliveryAddress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String status, @JsonKey(name: 'refund_status')  String refundStatus, @JsonKey(name: 'placed_at')  String placedAt, @JsonKey(name: 'status_history')  List<OrderStatusChangeModel> statusHistory, @JsonKey(name: 'delivery_otp')  String deliveryOtp, @JsonKey(name: 'payment_id')  String paymentId, @JsonKey(name: 'coupon_code')  String couponCode, @JsonKey(name: 'coupon_discount')  double couponDiscount, @JsonKey(name: 'delivery_fee')  double deliveryFee,  int rating, @JsonKey(name: 'review_text')  String reviewText, @JsonKey(name: 'reviewed_at')  String reviewedAt,  List<OrderLineItemModel> items, @JsonKey(name: 'delivery_address')  AddressModel? deliveryAddress)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.status,_that.refundStatus,_that.placedAt,_that.statusHistory,_that.deliveryOtp,_that.paymentId,_that.couponCode,_that.couponDiscount,_that.deliveryFee,_that.rating,_that.reviewText,_that.reviewedAt,_that.items,_that.deliveryAddress);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,refundStatus,placedAt,const DeepCollectionEquality().hash(_statusHistory),deliveryOtp,paymentId,couponCode,couponDiscount,deliveryFee,rating,reviewText,reviewedAt,const DeepCollectionEquality().hash(_items),deliveryAddress);
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? refundStatus = null,Object? placedAt = null,Object? statusHistory = null,Object? deliveryOtp = null,Object? paymentId = null,Object? couponCode = null,Object? couponDiscount = null,Object? deliveryFee = null,Object? rating = null,Object? reviewText = null,Object? reviewedAt = null,Object? items = null,Object? deliveryAddress = freezed,}) {
