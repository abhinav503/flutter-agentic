...
class _LoginScreenState extends BaseScreenState<LoginScreen>
  ...
  /// Signing up satisfies whatever gate opened this Login, so a successful
  /// Signup resolves this screen too rather than dropping the shopper back
  /// onto a form they no longer need.
  Future<void> _openSignup() async {
    final signedIn = await context.push<bool>(AppRoutes.signup) ?? false;
    if (signedIn && mounted) _completeAuth();
  }
