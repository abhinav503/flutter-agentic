...
@JsonKey(name: 'recent_searches') List<String> get recentSearches;@JsonKey(name: 'popular_products') List<ProductModel> get popularProducts;
...
@useResult
$Res call({
@JsonKey(name: 'recent_searches') List<String> recentSearches,@JsonKey(name: 'popular_products') List<ProductModel> popularProducts
});
...
as List<String>,popularProducts: null == popularProducts ? _self.popularProducts : popularProducts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'recent_searches')  List<String> recentSearches, @JsonKey(name: 'popular_products')  List<ProductModel> popularProducts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'recent_searches')  List<String> recentSearches, @JsonKey(name: 'popular_products')  List<ProductModel> popularProducts)  $default,) {final _that = this;
switch (_that) {
case _SearchModel():
return $default(_that.recentSearches,_that.popularProducts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'recent_searches')  List<String> recentSearches, @JsonKey(name: 'popular_products')  List<ProductModel> popularProducts)?  $default,) {final _that = this;
switch (_that) {
case _SearchModel() when $default != null:
return $default(_that.recentSearches,_that.popularProducts);case _:
  return null;
...
class _SearchModel extends SearchModel {
  const _SearchModel({@JsonKey(name: 'recent_searches') required final  List<String> recentSearches, @JsonKey(name: 'popular_products') required final  List<ProductModel> popularProducts}): _recentSearches = recentSearches,_popularProducts = popularProducts,super._();
...
as List<String>,popularProducts: null == popularProducts ? _self._popularProducts : popularProducts // ignore: cast_nullable_to_non_nullable
as List<ProductModel>,
  ));
}
