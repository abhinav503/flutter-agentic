...
mixin _$AddressModel {
 ...
 String get id; String get name; String get phone;@JsonKey(name: 'address_line') String get addressLine; String get tag;@JsonKey(name: 'is_default') bool get isDefault;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,addressLine,tag,isDefault);

@override
String toString() {
  return 'AddressModel(id: $id, name: $name, phone: $phone, addressLine: $addressLine, tag: $tag, isDefault: $isDefault)';
}
...
@useResult
$Res call({
 String id, String name, String phone,@JsonKey(name: 'address_line') String addressLine, String tag,@JsonKey(name: 'is_default') bool isDefault
});
...
/// Create a copy of AddressModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? addressLine = null,Object? tag = null,Object? isDefault = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String phone, @JsonKey(name: 'address_line')  String addressLine,  String tag, @JsonKey(name: 'is_default')  bool isDefault)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.addressLine,_that.tag,_that.isDefault);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String phone, @JsonKey(name: 'address_line')  String addressLine,  String tag, @JsonKey(name: 'is_default')  bool isDefault)  $default,) {final _that = this;
switch (_that) {
case _AddressModel():
return $default(_that.id,_that.name,_that.phone,_that.addressLine,_that.tag,_that.isDefault);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String phone, @JsonKey(name: 'address_line')  String addressLine,  String tag, @JsonKey(name: 'is_default')  bool isDefault)?  $default,) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.addressLine,_that.tag,_that.isDefault);case _:
  return null;
...
class _AddressModel extends AddressModel {
  const _AddressModel({required this.id, required this.name, required this.phone, @JsonKey(name: 'address_line') required this.addressLine, required this.tag, @JsonKey(name: 'is_default') required this.isDefault}): super._();
...
/// Create a copy of AddressModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? addressLine = null,Object? tag = null,Object? isDefault = null,}) {
